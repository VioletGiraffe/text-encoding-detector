...
// The committed corpus in tests/corpus: real prose in six languages, each verified to survive the 8-bit
// codecs listed for it without losing a character. See tests/corpus/README.md for sources and preparation.
